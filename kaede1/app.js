...
const BASELINE_100 = 30; // 100%の回数（筋肉痛なしの腹筋+腹斜筋の合計回数）
...
const DIFFS = [
  { key: 'easy', label: 'easy', base: 10, rmin: 1, rmax: 10 },
  { key: 'normal', label: 'normal', base: 15, rmin: 11, rmax: 15 },
  { key: 'hard', label: 'hard', base: 30, rmin: 16, rmax: 30 },
];

// soreness: core 20から減算（random）
const SORENESS = {
  none:   { label: 'なし',   min: 0,  max: 0 },
  sweet:  { label: '甘め',   min: 0,  max: 10 },
  normal: { label: '普通',   min: 11,  max: 15 },
  hard:   { label: '難しい', min: 16, max: 20 },
};
